    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchButton) {
            searchButton.addEventListener('click', function(e) {
                ...
                // Always ensure menu is open and search is focused
                if (mobileMenu) {
                    ...
                    if (isMenuHidden) {
                        ...
                        // Menu already open, just focus search
                        focusSearchInput();
                    }
                }

                function focusSearchInput() {
                    const searchInput = mobileMenu.querySelector('#mobile-search-input');
                    if (searchInput) {
                        searchInput.focus();
                        // Trigger mobile keyboard on touch devices
...
<style>
    ...
    /* Mobile search button animation */
