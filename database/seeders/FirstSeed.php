...
class FirstSeed extends Seeder
{
    ...
    private function createSettings()
    {
        Setting::create([
            ...
            'seo_title' => 'ESAT - Thiết bị điện tử chất lượng cao',
            'seo_description' => 'ESAT chuyên cung cấp thiết bị điện tử, linh kiện công nghệ chính hãng với giá cả hợp lý.',
            'og_image_link' => '/images/og-image.jpg',
            'hotline' => '0913718995',
            'address' => '',
            'email' => 'kinhdoanh@esat.vn',
            'slogan' => 'Thiết bị điện tử chất lượng cao',
            'facebook_link' => '',
            'zalo_link' => '',
            'youtube_link' => '',
            'tiktok_link' => '',
            'working_hours' => '8:00 - 17:00 (Thứ 2 - Thứ 7)',
            'dmca_link' => '',
            'footer_description' => '',
            'order' => 1,
            'status' => 'active',
    ...
    private function createCatProducts()
    {
        $categories = [
            [
                ...
                'seo_title' => 'Thiết bị điện tử - ESAT',
                'seo_description' => 'Thiết bị điện tử chất lượng cao, đa dạng sản phẩm.',
                'image' => '/images/categories/thiet-bi-dien-tu.jpg',
                'description' => 'Các loại thiết bị điện tử đa dạng',
                'order' => 1,
                'status' => 'active',
            ],
            [
                'name' => 'Linh kiện',
                'slug' => 'linh-kien',
                'seo_title' => 'Linh kiện điện tử - ESAT',
                'seo_description' => 'Linh kiện điện tử chính hãng, đảm bảo chất lượng.',
                'image' => '/images/categories/linh-kien.jpg',
                'description' => 'Linh kiện điện tử chính hãng',
                'order' => 2,
                'status' => 'active',
            ],
            [
                'name' => 'Phụ kiện',
                'slug' => 'phu-kien',
                'seo_title' => 'Phụ kiện điện tử - ESAT',
                'seo_description' => 'Phụ kiện điện tử đa dạng mẫu mã, chất lượng cao.',
