...
return [
    ...
    'except' => [
        'telescope*',
        'horizon*',
        'admin/login*',  // Không hiển thị debugbar trên trang login admin
        'api/*',         // Không hiển thị debugbar cho API routes
    ],
    ...
    */
    ...
    'options' => [
        ...
        'db' => [
            ...
            'timeline'          => env('DEBUGBAR_OPTIONS_DB_TIMELINE', true),   // Add the queries to the timeline - ENABLED for better debugging
            ...
            'explain' => [                 // Show EXPLAIN output on queries
                'enabled' => env('DEBUGBAR_OPTIONS_DB_EXPLAIN_ENABLED', true),  // ENABLED for query optimization
            ],
            'hints'             => env('DEBUGBAR_OPTIONS_DB_HINTS', true),       // ENABLED - Show hints for common mistakes
